...
EasySkillTreesOption = Option("Easy Affinity Trees", QOL, "Makes trust the only condition for leveling up a blade's affinity tree", [lambda: SkillTrees.BladeSkillTreeShortening(IDs.AllBladeIDs, 15), lambda: SkillTrees.BladeSkillTreeShortening(IDs.TornaBladeIDs, 15)])
